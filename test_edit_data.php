...
<?php
$id = $_GET['id'];
$res = mysqli_query($link, "select * from entry where id='$id'");
echo $id;
...
<div class="container-fluid">
    <div class="container">
        <div class="row bg-light py-3 my-2">
            <div class="col-12">
                <form action="" enctype="multipart/form-data" name="add_data_form" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="phone_number" value="<?php echo $row['phone_number'];?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
...
if (isset($_POST['update'])) {
    ...
    mysqli_query($link, "UPDATE `entry` SET `id`='$id',`name`='$name',`email`='$email',`pass`='$pass',`phone_number`='$phone_number',`date`='$date',`area`='$area',`gender`='$gender',`interest`='$interest',`photo`='$photo' WHERE id='$id';");

    if (move_uploaded_file($_FILES['photo']['tmp_name'], $target)) {
        ?>

        <div class="alert-danger">
            <h3>data Update Successfully</h3>
        </div>
        ...
        <div class="container alert-danger">
            <h3 class="text-center">data Not Updated</h3>
        </div>
